package com.kervan.payment.infrastructure.config;

import com.kervan.payment.infrastructure.messaging.UnsupportedCommandException;
...
class KafkaErrorHandlingConfig {
    ...
    DefaultErrorHandler kafkaErrorHandler(
        ...
        // Bazı hatalar beklemekle düzelmez. Tanınmayan bir komut tipi, yeniden
        // denendiğinde de tanınmaz; denemek yalnızca partition'ı geciktirir. Bu tür
        // hatalar doğrudan DLT'ye gider.
        handler.addNotRetryableExceptions(UnsupportedCommandException.class);
