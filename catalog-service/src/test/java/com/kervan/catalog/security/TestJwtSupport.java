package com.kervan.catalog.security;
 ...
 *
 * <p>order-service'teki eşinin kopyası. Test yardımcısı olduğu için kopya kabul
 * edildi: üretim kodu değil, ve iki servis birbirinden bağımsız kalsın diye. Üçüncü
 * bir servis de aynısına ihtiyaç duyarsa ortak bir test modülüne çıkarılmalı.
 */
@TestConfiguration
